...
*Figure 3.1 — Seven fields, in two groups. The four on the left are what lets an agent execute the work; the three on the right are what lets a human audit it afterwards, and they are the ones most often left out. The reviewer field is the one that makes the rest bite: an acceptance criterion with nobody named to apply it is decoration. This schema comes back in Chapters 10 and 15. (Rendered as `figures/figure-3-1.svg` from the brief below, per `FIGURES.md`.)*
...
- caption:       Figure 3.1 — Seven fields, in two groups. The four on the left are what lets an agent execute the work; the three on the right are what lets a human audit it afterwards, and they are the ones most often left out. The reviewer field is the one that makes the rest bite: an acceptance criterion with nobody named to apply it is decoration. This schema comes back in Chapters 10 and 15.
